package kr.co.skcc.oss.bap.scheduler.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"kr.co.skcc.oss.bap.scheduler.repository"}
)
...
public class QuartzDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean quartzEntityManagerFactory(@Qualifier("quartzDataSource") DataSource dataSource) {
        ...
        factory.setPackagesToScan(new String[]{"kr.co.skcc.oss.bap.scheduler.domain"});
