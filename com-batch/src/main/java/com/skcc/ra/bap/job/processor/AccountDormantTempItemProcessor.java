...
@Slf4j
public class AccountDormantTempItemProcessor implements ItemProcessor<Object, Account> {

    AccountRepository accountRepository;

    public AccountDormantTempItemProcessor(AccountRepository accountRepository) {
