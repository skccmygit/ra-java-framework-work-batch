...
public class AgentStartItemReader extends JpaPagingItemReader<Agent> {

    private final static int CHUNK_SIZE = 5;

    public AgentStartItemReader(EntityManagerFactory entityManagerFactory) {
        ...
        String query = "SELECT A.AGENT_REG_SEQ                   \n" +
                    ...
                    "   WHERE 1=1                                               \n" +
                    "     AND A.END_YN = 'N'                                    \n" +
                    "     AND A.AGENT_START_DT = DATE_FORMAT(NOW(),'%Y%m%d')    \n";
